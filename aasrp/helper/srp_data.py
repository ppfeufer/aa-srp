...
def localized_isk_value(loss_amount: int) -> str:
    """
    Generate a localized ISK value string with the currency symbol.

    :param loss_amount: The loss amount to localize.
    :type loss_amount: int
    :return: Localized ISK value string.
    :rtype: str
    """
